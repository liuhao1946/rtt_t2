...
#### 搜索<_SEGGER_RTT>地址
参考[如果你选择的芯片能被识别但rtt_t2无法显示你发送过来的数据](#如果你选择的芯片能被识别但rtt_t2无法显示你发送过来的数据)
...
## FAQ
#### 运行rtt_t2报错：TypeError: Expected to be given a valid DLL.
...
#### 如果你选择的芯片能被识别但rtt_t2无法显示你发送过来的数据？
